...
def get_basic_instruction():
    return "Ask me when is the next train from one station to another station.\n" \
            "For example, ask me 'When is the next train from Harvard to Park Street?'"
...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the Boston Transit!\n" \
                    "If you would like transit arrival predictions, " \
                    "ask me when is the next train from a station to another station."
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = get_basic_instruction()
...
def handle_unknown_request():
    session_attributes = {}
    card_title = "Unknown Request"
    speech_output = "Sorry, I'm not sure.\n" + get_basic_instruction()
    should_end_session = False
    return build_response(session_attributes, build_speechlet_response(
...
def handle_session_end_request():
    ...
    speech_output = "Thank you for using our Boston Transit skill. " \
                    "Have a nice trip!"
